...
This design allows RI-MELD to reduce the dependence on manually selected reward parameters and provides a more adaptive way to use noisy, sparse, or uncertain restraint information.
