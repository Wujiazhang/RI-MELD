...
setup_system()
#sbatch --nodelist=g01n16 job.sh
# python CPI_adapt.py
# nohup mpirun -np 1 launch_remd > meld.log 2>&1 &
# nohup mpirun 1 launch_remd > meld.log 2>&1 &
# ps -p 236275 -o pid,ppid,cmd,%mem,%cpu
# disown 236275
# kill 236275
# sbatch --nodelist=g01n11 job.sh
# mkdssp -i ref2.pdb -o 3gb1.dssp
# conda env create -n meld python=3.10
#  conda create -n dssp python=3.7